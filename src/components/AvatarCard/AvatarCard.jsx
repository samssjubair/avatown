        ...
        <div className='col-lg-3 col-md-6 col-sm-12 p-1'>
            ...
            <div className="card-body">
                ...
                <div className="col-10 d-flex">
                    ...
                    <p className="card-text">{data.rating} & {data.likes} likes</p>
                </div>
                <div className="col-2">
                ...
                <div>
                    <img src={ava} alt="avatar" className='rounded-circle ava-creator me-1'/>
                    <span className='creator-name'>Avatar Joe's</span>
                </div>
                
                <p className="card-text fs-4 mb-1"><small>$</small>{data.price}</p>
